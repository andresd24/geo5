...
const config = require('../examples/react-public-path/webpack.config');

describe('React Public Path', function() {
  ...
  it('should create original route', () => {
    ...
    const fixture = fs.readFileSync(path.resolve(__dirname, 'fixtures/react-public-path.html')).toString();
  ...
  it('should clone original to Page 1 route with public path in place', () => {
    ...
    const cloned_fixture = fs.readFileSync(path.resolve(__dirname, 'fixtures/react-public-path-page1.html')).toString();
  ...
  it('should clone original to Page 2 route with public path in place', () => {
    ...
    const cloned_fixture = fs.readFileSync(path.resolve(__dirname, 'fixtures/react-public-path-page2.html')).toString();
